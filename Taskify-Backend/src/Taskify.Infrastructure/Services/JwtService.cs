...
public class JwtService : IJwtService
{
    ...
    public JwtService(IConfiguration configuration)
    {
        ...
        _secretKey = _configuration["Jwt:SecretKey"] ?? "YourSecretKeyHereThatShouldBeAtLeast32CharactersLong!";
        _issuer = _configuration["Jwt:Issuer"] ?? "TaskifyAPI";
        _audience = _configuration["Jwt:Audience"] ?? "TaskifyClient";
