    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProjects", x => new { x.AssignedProjectsId, x.AssignedUsersId });
                    table.ForeignKey(
                        name: "FK_UserProjects_Projects_AssignedProjectsId",
                        column: x => x.AssignedProjectsId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProjects_Users_AssignedUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProjects_AssignedUsersId",
                table: "UserProjects",
